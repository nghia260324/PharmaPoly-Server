...
//const CloudinaryUpload = require("../config/common/cloudinaryUpload"); 
...
// router.put('/edit/:id', CloudinaryUpload.array('images', 10), async (req, res) => {
//     try {
//         const productId = req.params.id;
//         const data = req.body;
//         const files = req.files;
...
//             const imagesToDelete = await ProductImages.find({ _id: { $in: deletedImageIds } });
...
//             let newImages = files.map((file, index) => ({
//                 product_id: productId,
//                 image_url: file.path,
//                 is_primary: sortOrders[index] === 0,
